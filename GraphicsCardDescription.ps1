...
$objForm.Text = "       Graphics Card Description"
$objForm.Size = New-Object System.Drawing.Size(700,700) 
...
$objTextBox2.Size = New-Object System.Drawing.Size(600,500)
...
$OKButton.add_Click({
    ...
    try{
        ## Uncomment this section if you want in GRID-VIEW
        # Invoke-Command -cn $ComputerName -ScriptBlock{Get-WmiObject Win32_PnPSignedDriver| where {$_.devicename -like "*nvidia*"}} | Select-Object Description, DriverVersion | Out-GridView
        
        ## Uncomment this section if you want in LIST-VIEW
        $display = Invoke-Command -cn $ComputerName -ScriptBlock{Get-WmiObject Win32_PnPSignedDriver| where {$_.devicename -like "*nvidia*"}} | Select-Object Description, DriverVersion
        $objTextBox2.Text = $display | Format-Table -AutoSize | Out-String
    }
    catch{
        $objTextBox2.Text = [System.Windows.MessageBox]::Show($_.exception.message,"Error",[System.Windows.MessageBoxButton]::OK,[System.Windows.MessageBoxImage]::Error)
    }
})
